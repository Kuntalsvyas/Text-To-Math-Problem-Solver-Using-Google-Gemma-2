...
prompt="""
Your a agent tasked for solving users mathematical questions. Logically arrives at the solution and provide a detailed explanation
and display it point wise from the question below 
Question:{question}
Answer:
"""
